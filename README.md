...
| [`/claude-code`](src/claude-code/) | Delegate a coding task to a Claude Code session in the workspace container                   | `CLAUDE_CODE_OAUTH_TOKEN`     |
...
```bash
npm test          # 580 specs, no credentials and no network
